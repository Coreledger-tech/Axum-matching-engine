...
public final class CoreSymbolSpecification implements WriteBytesMarshallable, StateHash {
    ...
    public final int // base currency
     baseCurrency;
    public final int // quote/counter currency (OR futures contract currency)
     quoteCurrency;
    public final long // base currency amount multiplier (lot size in base currency units)
     baseScaleK;
    public final long // quote currency amount multiplier (step size in quote currency units)
     quoteScaleK;
    // fees per lot in quote? currency units
    public final long // TODO check invariant: taker fee is not less than maker fee
     takerFee;
    public final long makerFee;
    // margin settings (for type=FUTURES_CONTRACT only)
    public final long // buy margin (quote currency)
     marginBuy;
    public final long // sell margin (quote currency)
     marginSell;
