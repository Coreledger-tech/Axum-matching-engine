...
public final class TotalCurrencyBalanceReportQuery implements ReportQuery<TotalCurrencyBalanceReportResult> {
    ...
    public Optional<TotalCurrencyBalanceReportResult> process(final MatchingEngineRouter matchingEngine) {
        ...
        matchingEngine.getOrderBooks().stream().filter(ob -> ob.getSymbolSpec().type == SymbolType.CURRENCY_EXCHANGE_PAIR).forEach(ob -> {
            final CoreSymbolSpecification spec = ob.getSymbolSpec();
            currencyBalance.addToValue(spec.getBaseCurrency(), ob.askOrdersStream(false).mapToLong(ord -> CoreArithmeticUtils.calculateAmountAsk(ord.getSize() - ord.getFilled(), spec)).sum());
            currencyBalance.addToValue(spec.getQuoteCurrency(), ob.bidOrdersStream(false).mapToLong(ord -> CoreArithmeticUtils.calculateAmountBidTakerFee(ord.getSize() - ord.getFilled(), ord.getReserveBidPrice(), spec)).sum());
        });
    ...
    public Optional<TotalCurrencyBalanceReportResult> process(final RiskEngine riskEngine) {
        ...
        return Optional.of(new TotalCurrencyBalanceReportResult(currencyBalance, new IntLongHashMap(riskEngine.getFees()), new IntLongHashMap(riskEngine.getAdjustments()), new IntLongHashMap(riskEngine.getSuspends()), null, symbolOpenInterestLong, symbolOpenInterestShort));
    }
    ...
    public boolean equals(final java.lang.Object o) {
        ...
        if (!(o instanceof TotalCurrencyBalanceReportQuery)) return false;
        return true;
    }
    ...
    public java.lang.String toString() {
        return "TotalCurrencyBalanceReportQuery()";
    }
}
