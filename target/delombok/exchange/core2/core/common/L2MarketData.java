...
//    public long totalVolumeBid;
    ...
    public java.lang.String toString() {
        return "L2MarketData(askSize=" + this.askSize + ", bidSize=" + this.bidSize + ", askPrices=" + java.util.Arrays.toString(this.askPrices) + ", askVolumes=" + java.util.Arrays.toString(this.askVolumes) + ", askOrders=" + java.util.Arrays.toString(this.askOrders) + ", bidPrices=" + java.util.Arrays.toString(this.bidPrices) + ", bidVolumes=" + java.util.Arrays.toString(this.bidVolumes) + ", bidOrders=" + java.util.Arrays.toString(this.bidOrders) + ", timestamp=" + this.timestamp + ", referenceSeq=" + this.referenceSeq + ")";
    }
    // TODO hashcode
}
