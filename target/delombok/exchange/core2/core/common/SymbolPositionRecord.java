...
public final class SymbolPositionRecord implements WriteBytesMarshallable, StateHash {
    ...
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(SymbolPositionRecord.class);
    public long uid;
    public int symbol;
    public int currency;
...
//        }
    ...
    public long estimateProfit(final CoreSymbolSpecification spec, final RiskEngine.LastPriceCacheRecord lastPriceCacheRecord) {
        ...
        case EMPTY: 
            return profit;
        case LONG: 
            return profit + ((lastPriceCacheRecord != null && lastPriceCacheRecord.bidPrice != 0) ? (openVolume * lastPriceCacheRecord.bidPrice - openPriceSum) : spec.marginBuy * openVolume); // unknown price - no liquidity - require extra margin
        case SHORT: 
            return profit + ((lastPriceCacheRecord != null && lastPriceCacheRecord.askPrice != Long.MAX_VALUE) ? (openPriceSum - openVolume * lastPriceCacheRecord.askPrice) : spec.marginSell * openVolume); // unknown price - no liquidity - require extra margin
        default: 
    ...
    public String toString() {
        return "SPR{u" + uid + " sym" + symbol + " cur" + currency + " pos" + direction + " Σv=" + openVolume + " Σp=" + openPriceSum + " pnl=" + profit + " pendingS=" + pendingSellSize + " pendingB=" + pendingBuySize + '}';
    }
