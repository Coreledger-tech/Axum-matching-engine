...
public final class OrdersBucketNaive implements Comparable<OrdersBucketNaive>, WriteBytesMarshallable {
    ...
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(OrdersBucketNaive.class);
...
//            log.debug("totalMatchingVolume={} v={}", totalMatchingVolume, v);
    ...
    public String dumpToSingleLine() {
        String orders = getAllOrders().stream().map(o -> String.format("id%d_L%d_F%d", o.orderId, o.size, o.filled)).collect(Collectors.joining(", "));
    ...
    public boolean equals(Object o) {
        ...
        return price == other.getPrice() && getAllOrders().equals(other.getAllOrders());
    }
    ...
    public final class MatcherResult {
        ...
        @java.lang.SuppressWarnings("all")
        public MatcherResult(final MatcherTradeEvent eventsChainHead, final MatcherTradeEvent eventsChainTail, final long volume, final List<Long> ordersToRemove) {
            this.eventsChainHead = eventsChainHead;
            this.eventsChainTail = eventsChainTail;
            this.volume = volume;
    ...
    public java.lang.String toString() {
        return "OrdersBucketNaive(price=" + this.getPrice() + ", entries=" + this.entries + ", totalVolume=" + this.getTotalVolume() + ")";
    }
