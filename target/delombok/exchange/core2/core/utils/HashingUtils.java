...
public final class HashingUtils {
    ...
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(HashingUtils.class);
    ...
    public static boolean checkStreamsEqual(final Stream<?> s1, final Stream<?> s2) {
        final Iterator<?> iter1 = s1.iterator();
        final Iterator<?> iter2 = s2.iterator();
