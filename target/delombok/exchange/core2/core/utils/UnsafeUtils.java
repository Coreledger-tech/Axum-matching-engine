...
public final class UnsafeUtils {
    ...
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(UnsafeUtils.class);
    ...
    public static void setResultVolatile(final OrderCommand cmd, final boolean result, final CommandResultCode successCode, final CommandResultCode failureCode) {
        ...
        // do a CAS operation
        (!UNSAFE.compareAndSwapObject(cmd, OFFSET_RESULT_CODE, currentCode, codeToSet));
    }
    ...
    public static void appendEventsVolatile(final OrderCommand cmd, final MatcherTradeEvent eventHead) {
        ...
        // do a CAS operation
        (!UNSAFE.compareAndSwapObject(cmd, OFFSET_EVENT, tail.nextEvent, eventHead));
    }
}
