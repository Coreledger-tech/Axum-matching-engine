...
public final class MatchingEngineRouter implements WriteBytesMarshallable {
    ...
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(MatchingEngineRouter.class);
    public static final ISerializationProcessor.SerializedModuleType MODULE_ME = ISerializationProcessor.SerializedModuleType.MATCHING_ENGINE_ROUTER;
    // state
    ...
    public MatchingEngineRouter(final int shardId, final long numShards, final ISerializationProcessor serializationProcessor, final IOrderBook.OrderBookFactory orderBookFactory, final SharedPool sharedPool, final ExchangeConfiguration exchangeCfg) {
        ...
        if (ISerializationProcessor.canLoadFromSnapshot(serializationProcessor, initStateCfg, shardId, MODULE_ME)) {
            final DeserializedData deserialized = serializationProcessor.loadData(initStateCfg.getSnapshotId(), ISerializationProcessor.SerializedModuleType.MATCHING_ENGINE_ROUTER, shardId, bytesIn -> {
                ...
                final BinaryCommandsProcessor bcp = new BinaryCommandsProcessor(this::handleBinaryMessage, this::handleReportQuery, sharedPool, exchangeCfg.getReportsQueriesCfg(), bytesIn, shardId + 1024);
                final IntObjectHashMap<IOrderBook> ob = SerializationUtils.readIntHashMap(bytesIn, bytes -> IOrderBook.create(bytes, objectsPool, eventsHelper, loggingCfg));
            ...
            this.binaryCommandsProcessor = new BinaryCommandsProcessor(this::handleBinaryMessage, this::handleReportQuery, sharedPool, exchangeCfg.getReportsQueriesCfg(), shardId + 1024);
    ...
    public void processOrder(long seq, OrderCommand cmd) {
        ...
        if (command == OrderCommandType.MOVE_ORDER || command == OrderCommandType.CANCEL_ORDER || command == OrderCommandType.PLACE_ORDER || command == OrderCommandType.REDUCE_ORDER || command == OrderCommandType.ORDER_BOOK_REQUEST) {
            ...
            final boolean isSuccess = serializationProcessor.storeData(cmd.orderId, seq, cmd.timestamp, ISerializationProcessor.SerializedModuleType.MATCHING_ENGINE_ROUTER, shardId, this);
...
//        log.debug("ME add symbolSpecification: {}", symbolSpecification);
    ...
    private void processMatchingCommand(final OrderCommand cmd) {
        ...
        if (orderBook == null) {
            ...
            if ((cfgSendL2ForEveryCmd || (cmd.serviceFlags & 1) != 0) && cmd.command != OrderCommandType.ORDER_BOOK_REQUEST && cmd.resultCode == CommandResultCode.SUCCESS) {
    ...
    private static class DeserializedData {
        ...
        public static class DeserializedDataBuilder {
            ...
            @java.lang.SuppressWarnings("all")
            public MatchingEngineRouter.DeserializedData.DeserializedDataBuilder binaryCommandsProcessor(final BinaryCommandsProcessor binaryCommandsProcessor) {
                this.binaryCommandsProcessor = binaryCommandsProcessor;
                return this;
            }

            @java.lang.SuppressWarnings("all")
            public MatchingEngineRouter.DeserializedData.DeserializedDataBuilder orderBooks(final IntObjectHashMap<IOrderBook> orderBooks) {
                this.orderBooks = orderBooks;
                return this;
            }

            @java.lang.SuppressWarnings("all")
            public MatchingEngineRouter.DeserializedData build() {
                return new MatchingEngineRouter.DeserializedData(this.binaryCommandsProcessor, this.orderBooks);
            }
        ...
        @java.lang.SuppressWarnings("all")
        public static MatchingEngineRouter.DeserializedData.DeserializedDataBuilder builder() {
            return new MatchingEngineRouter.DeserializedData.DeserializedDataBuilder();
        }

        @java.lang.SuppressWarnings("all")
        public DeserializedData(final BinaryCommandsProcessor binaryCommandsProcessor, final IntObjectHashMap<IOrderBook> orderBooks) {
            this.binaryCommandsProcessor = binaryCommandsProcessor;
            this.orderBooks = orderBooks;
        }
    }
    ...
    @java.lang.SuppressWarnings("all")
    public boolean isCfgSendL2ForEveryCmd() {
        return this.cfgSendL2ForEveryCmd;
    }

    @java.lang.SuppressWarnings("all")
    public int getCfgL2RefreshDepth() {
        return this.cfgL2RefreshDepth;
    }
