...
public final class TwoStepSlaveProcessor implements EventProcessor {
    ...
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(TwoStepSlaveProcessor.class);
    ...
    public TwoStepSlaveProcessor(final RingBuffer<OrderCommand> ringBuffer, final SequenceBarrier sequenceBarrier, final SimpleEventHandler eventHandler, final ExceptionHandler<? super OrderCommand> exceptionHandler, final String name) {
