...
public final class GroupingProcessor implements EventProcessor {
    ...
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(GroupingProcessor.class);
    ...
    public GroupingProcessor(RingBuffer<OrderCommand> ringBuffer, SequenceBarrier sequenceBarrier, PerformanceConfiguration perfCfg, CoreWaitStrategy coreWaitStrategy, SharedPool sharedPool) {
            ...
            try {
                ...
                if (nextSequence <= availableSequence) {
                    while (nextSequence <= availableSequence) {
                        ...
                        if (cmd.command == OrderCommandType.RESET || cmd.command == OrderCommandType.PERSIST_STATE_MATCHING || cmd.command == OrderCommandType.GROUPING_CONTROL) {
                            groupCounter++;
                            msgsInGroup = 0;
                        }
