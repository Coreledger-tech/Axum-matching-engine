...
public final class TwoStepMasterProcessor implements EventProcessor {
    ...
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(TwoStepMasterProcessor.class);
    ...
    public TwoStepMasterProcessor(final RingBuffer<OrderCommand> ringBuffer, final SequenceBarrier sequenceBarrier, final SimpleEventHandler eventHandler, final ExceptionHandler<OrderCommand> exceptionHandler, final CoreWaitStrategy coreWaitStrategy, final String name) {
    ...
    @java.lang.SuppressWarnings("all")
    public void setSlaveProcessor(final TwoStepSlaveProcessor slaveProcessor) {
